...
The longer form is kept in `docs/NICOLAS-CHART.md` — ten lines, each with a column of
options, plus a map of which lines are alive on which baseline. It is good thinking and it is
the right tool if you have half a day. It does not fit fifty minutes.
